...
def trainModelWithDMC(p_boardSizeX, p_boardSizeY, p_episodes, savePath, p_temperature=20.0, p_gamma=0.9, howFar=2, rewardFunc=game.rewardFunc3, selfPlayFixOpp=False, startingModel=None, opponentConstr=None, opponentStrength=None):
...
trainModelWithDMC(p_boardSizeX=6,p_boardSizeY=6,p_episodes=50000,savePath='resultsPSR/reward/modelReward3',startingModel=None,opponentConstr=game.AILook1Player,opponentStrength=5)
