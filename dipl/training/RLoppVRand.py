...
trainModelWithDMC(p_boardSizeX=6,p_boardSizeY=6,p_episodes=50000,savePath='resultsPSR/opp/modelVRand',startingModel=None,opponentConstr=game.RandomPlayer)
