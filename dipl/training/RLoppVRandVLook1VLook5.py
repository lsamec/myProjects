...
trainModelWithDMC(p_boardSizeX=6,p_boardSizeY=6, p_temperature=20.0,p_episodes=16666,savePath='resultsPSR/opp/modelVRandVLook1VLook5',startingModel=None,opponentConstr=game.RandomPlayer)
trainModelWithDMC(p_boardSizeX=6,p_boardSizeY=6, p_temperature=10.0,p_episodes=16666,savePath='resultsPSR/opp/modelVRandVLook1VLook5_1',startingModel=load_model('resultsPSR/opp/modelVRandVLook1VLook5'),opponentConstr=game.AILook1Player, opponentStrength=1)
trainModelWithDMC(p_boardSizeX=6,p_boardSizeY=6, p_temperature=5.0,p_episodes=16666,savePath='resultsPSR/opp/modelVRandVLook1VLook5_2',startingModel=load_model('resultsPSR/opp/modelVRandVLook1VLook5_1'),opponentConstr=game.AILook1Player, opponentStrength=5)
